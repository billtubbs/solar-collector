...
def test_read_param_values_additional_fields():
    ...
    assert result['fluid_density']['desc'] == 'The density of the fluid at normal operating conditions'
    ...
    assert result['collector_length']['desc'] == 'Total length of collector pipe'
